...
public class ManageEmployee {
	...
	public static void main(String[] args) {
	   ...
	   // Unidirection and crude methods.....................
	        ...
	        HashSet<MCertificate> certificate = new HashSet();
			certificate.add(new MCertificate("java"));
			certificate.add(new MCertificate("spring"));
			//Employee e = new Employee(1, "Akash","kamane",130000,certificate);
			//Integer id1= me.addCertificate(new MCertificate("BSC",e));
			Integer id1 = me.addEmployee(new Employee(1,"Akash","kamane",130000,certificate));
	...
	public Integer addCertificate(MCertificate certificate)
	{
		...
		{
			tx = session.beginTransaction();
			i = (Integer)session.save(certificate);
			tx.commit();
		}
		catch(Exception e)
		{
